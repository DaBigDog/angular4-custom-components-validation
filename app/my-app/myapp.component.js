...
var MyAppComponent = (function () {
    function MyAppComponent(dataService) {
    ...
    MyAppComponent.prototype.loadTypesData = function () {
        var _this = this;
    ...
    MyAppComponent.prototype.changeItem = function (event) {
        console.log(event);
    };
    MyAppComponent.prototype.logForm = function (value) {
        console.log(value);
    };
